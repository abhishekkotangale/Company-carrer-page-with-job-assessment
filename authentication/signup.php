      ...
      if(isset($_POST['submit'])){
        ...
        if($emailcount>0){
          ...
          if($password === $cpassword){
            $insertquery = "insert into users(username_user,email,gender,mobile,city,address,password,cpassword) values('$username','$email','$gender','$mobile','$city','$address','$pass','$cpass')";
    ...
    <div class="container-fluid background">
      ...
      <div class="container login-signup-form-height-width">
       <div class="card background-color shadow-lg   rounded">
         ...
         <div class="card-body">
          <p class="card-text text-danger">Register yourself to apply to various jobs</p>
